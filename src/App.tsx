...
function Welcome() {
  return (
    <div>
      <h1>Welcome to March Madness Month!</h1>
      <br></br>
      <h2><u>Below is a List of All NCAA Basketball Teams</u></h2>
      <br></br>
    </div>
  );
};
...
function Close() {
  return (
    <div>
      <h3>If you're reading this, you are dope!</h3>
    </div>
  );
};
